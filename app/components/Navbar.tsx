...
// Solid icon for the CV download (file/arrow down)
import { faFileArrowDown } from "@fortawesome/free-solid-svg-icons";
// Brand icons: GitHub, X (Twitter), LinkedIn
...
const Navbar = () => {
  ...
  return (
    <div className={`${isGlass ? "bg-black/10 backdrop-blur-xl" : "bg-black"} sticky top-0 z-50`}>
              ...
              <motion.div className="flex items-center">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <Tooltip title="Download CV" arrow>
                    <motion.a
                      href="/files/JYOTHESH_KARNAM_CV.pdf"
                  ...
                  <Tooltip title="GitHub" arrow>
                    <motion.a
                      href="https://github.com/jyotheshkar"
                      className="px-3 py-2 text-white flex items-center"
                      target="_blank"
                  ...
                  <Tooltip title="LinkedIn" arrow>
                    <motion.a
                      href="https://www.linkedin.com/in/jyothesh-karnam-5a90241bb/"
                      className="px-3 py-2 text-white flex items-center"
                      target="_blank"
                      rel="noopener noreferrer"
                      whileHover={{ scale: 1.1 }}
                  ...
                  {/* AWS Icon */}
                  <Tooltip title="AWS Projects" arrow>
                    <motion.a
                      href="https://learn.nextwork.org/serene_orange_smart_fox/portfolio"
                      className="px-3 py-2 text-white flex items-center"
                      target="_blank"
                      rel="noopener noreferrer"
                      whileHover={{ scale: 1.1 }}
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            className="fixed top-0 left-0 w-full h-14 bg-black flex items-center px-4 z-50"
            initial={{ x: "-100%" }}
            animate={{ x: "0%" }}
            exit={{ x: "-100%" }}
          ...
          >
            ...
            {/* Close Button */}
            <motion.button
              className="ml-auto bg-[#3e0101] text-red-600 rounded-full p-[5px] transition"
              onClick={toggleMobileMenu}
              whileHover={{ scale: 1 }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
